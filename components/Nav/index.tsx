    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
      <div className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between">
        <Link href={siteConfig.nav.home} className="flex items-center gap-0.5 group cursor-pointer">
          <span className="text-2xl font-bold text-foreground tracking-tight">AK</span>
        ...
        <div className="flex items-center gap-4">
          <ThemeButton />
          <a
            className="bg-primary text-primary-foreground px-6 py-2.5 text-sm font-medium rounded-md hover:opacity-90 transition-opacity"
